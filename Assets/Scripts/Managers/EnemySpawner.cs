...
public class EnemySpawner : MonoBehaviour
{
	...
	public float spawnRate = 5f;		//Rate, in seconds, to spawn enemies
	public int maxEnemies = 10;		//Maximum number of enemies that this spawner can have at a time
	...
	List<EnemyHealth> enemies = new List<EnemyHealth>();						//An array of the pooled enemies
	...
	void Update()
	{
		// if we've increased the max enemies count then add more to the pool
